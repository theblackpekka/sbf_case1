...
export default function Home() {
  return(
    <><NavBar />
    <div className="min-w-full h-svh px-10 md:px-20 bg-gradient-to-b from-bg to-white z-1 flex items-start md:items-center justify-between font-semibold medium text-main">
